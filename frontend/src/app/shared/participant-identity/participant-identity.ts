...
export class ParticipantIdentity {
  ...
  laneIconSize = input('sw-2.5 h-2.5 lg:w-3 lg:h-3');
  levelTextSize = input('text-[9px] lg:text-[10px]');
  spellSize = input('w-4 h-4 sm:w-3.5 sm:h-3.5 lg:w-4 lg:h-4');
  primaryRuneSize = input('w-4 h-4 sm:w-3 sm:h-3 lg:w-4 lg:h-4');
  secondaryRuneSize = input('w-3.5 h-3.5 sm:w-3 sm:h-3 lg:w-3.5 lg:h-3.5');
  nameSize = input('sm:text-[11px] md:text-xs lg:sm');
